...
Foam::fixed2TRhoFvPatchScalarField::fixed2TRhoFvPatchScalarField
(
    const fvPatch& p,
...
Foam::fixed2TRhoFvPatchScalarField::fixed2TRhoFvPatchScalarField
(
    const fixed2TRhoFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::fixed2TRhoFvPatchScalarField::fixed2TRhoFvPatchScalarField
(
    const fixed2TRhoFvPatchScalarField& frpsf
)
:
...
void Foam::fixed2TRhoFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::fixed2TRhoFvPatchScalarField::write(Ostream& os) const
{
