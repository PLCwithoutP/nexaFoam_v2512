...
namespace Foam
{
    defineTypeNameAndDebug(basicNeChemistryModel, 0);
}

// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

void Foam::basicNeChemistryModel::correct()
{}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::basicNeChemistryModel::basicNeChemistryModel(basic2TThermo& thermo)
:
    IOdictionary
    (
        IOobject
...
Foam::basicNeChemistryModel::~basicNeChemistryModel()
{}
