...
#include "reaction2TTypes.H"
#include "makeNeReaction.H"

#include "neArrheniusReactionRate.H"
...
#define makeReactions(Thermo, Reaction)                                        \
    ...
    defineTemplateRunTimeSelectionTable(Reaction, dictionary);                 \
                                                                               \
    makeIRReactions(Thermo, neArrheniusReactionRate)                          \
...
namespace Foam
{
    ...
    (
        ...
        blottnerEucken2TGasCThermoPhysicsHReaction
    )
