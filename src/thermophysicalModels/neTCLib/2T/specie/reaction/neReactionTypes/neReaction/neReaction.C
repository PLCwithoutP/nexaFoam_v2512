...
Foam::label Foam::neReaction<ReactionThermo>::nUnNamedReactions = 0;


// * * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * //

template<class ReactionThermo>
void Foam::neReaction<ReactionThermo>::reactionStr
(
...
template<class ReactionThermo>
void Foam::neReaction<ReactionThermo>::reactionStrLeft
(
    OStringStream& reaction
) const
{
...
template<class ReactionThermo>
void Foam::neReaction<ReactionThermo>::reactionStrRight
(
    OStringStream& reaction
) const
{
...
template<class ReactionThermo>
Foam::label Foam::neReaction<ReactionThermo>::getNewReactionID()
{
...
template<class ReactionThermo>
Foam::string Foam::neReaction<ReactionThermo>::reactionStr
(
    OStringStream& reaction
) const
{
...
template<class ReactionThermo>
void Foam::neReaction<ReactionThermo>::setThermo
(
...
template<class ReactionThermo>
Foam::neReaction<ReactionThermo>::neReaction
(
    const speciesTable& species,
...
Foam::neReaction<ReactionThermo>::neReaction
(
    const neReaction<ReactionThermo>& r,
    const speciesTable& species
)
:
...
template<class ReactionThermo>
Foam::neReaction<ReactionThermo>::specieCoeffs::specieCoeffs
(
    const speciesTable& species,
    Istream& is,
...
template<class ReactionThermo>
void Foam::neReaction<ReactionThermo>::setLRhs
(
    Istream& is,
    const speciesTable& species,
...
template<class ReactionThermo>
Foam::autoPtr<Foam::neReaction<ReactionThermo>>
Foam::neReaction<ReactionThermo>::New
(
    const speciesTable& species,
    const ReactionTable<ReactionThermo>& thermoDatabase,
    const dictionary& dict
...
template<class ReactionThermo>
void Foam::neReaction<ReactionThermo>::write(Ostream& os) const
{
    OStringStream reaction;
...
template<class ReactionThermo>
Foam::scalar Foam::neReaction<ReactionThermo>::kf
(
    const scalar p,
    const scalar T,
    const scalarField& c
...
template<class ReactionThermo>
Foam::scalar Foam::neReaction<ReactionThermo>::kr
(
    const scalar kfwd,
    const scalar p,
    const scalar T,
...
template<class ReactionThermo>
const Foam::speciesTable& Foam::neReaction<ReactionThermo>::gasSpecies() const
{
    NotImplemented;
...
template<class ReactionThermo>
const Foam::List<typename Foam::neReaction<ReactionThermo>::specieCoeffs>&
Foam::neReaction<ReactionThermo>::glhs() const
{
    NotImplemented;
...
template<class ReactionThermo>
const Foam::List<typename Foam::neReaction<ReactionThermo>::specieCoeffs>&
Foam::neReaction<ReactionThermo>::grhs() const
{
    NotImplemented;
    return List<specieCoeffs>::null();
}
